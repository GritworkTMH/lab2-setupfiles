...
<body class="bodyStyle">
	...
	<div id="mainContent">
		...
		<div id="mainPictures" class="center">
			...
			<hr>
			<div id="header" class="mainHeader"><p>Hnin caf&eacute; Employee List!</p></div>
			<br>

		<?php
		$connection_string = "host=hnindb.cluster-clwqm668m7ha.us-east-1.rds.amazonaws.com port=5432 dbname=hnindb
 user=thetdb password=thetmyat123";
